...
/**
 * @ngdoc function
 * @name pagoServiciosFrontendApp.controller:ReciboPagadoDetailCtrl
 * @description
 * # ReciboPagadoDetailCtrl
 * Controller of the pagoServiciosFrontendApp
 */
angular.module('pagoServiciosFrontendApp')
  .controller('ReciboPagadoDetailCtrl', function ($scope, $uibModalInstance, 
