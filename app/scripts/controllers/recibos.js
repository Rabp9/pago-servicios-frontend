...
.controller('RecibosCtrl', function ($scope, serviciosservice, recibosservice,
    ...
    $scope.showReporte = function(fecha_inicio, fecha_cierre) {
        var fechaInicio = $utilsViewService.formatDate(fecha_inicio);
        var fechaCierre = $utilsViewService.formatDate(fecha_cierre);
            ...
            recibosservice.get({
                ...
                var docDefinition = {
                    ...
                    content: [
                        ...
                        { text: 'Recibos registrados en el periodo del ' + fechaInicio + ' al ' + fechaCierre, style: 'paragraph' },
